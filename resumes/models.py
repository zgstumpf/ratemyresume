...
from .formatChecker import ContentTypeRestrictedFileField, WORD_PROCESSING_CONTENT_TYPES
...
class Resume(models.Model):
    ...
    file = ContentTypeRestrictedFileField(upload_to='resumes/', content_types=WORD_PROCESSING_CONTENT_TYPES,max_upload_size=1048576) # 1 MiB
    description = models.CharField(max_length=1000, blank=True)
    created_at = models.DateTimeField(auto_now_add=True)
